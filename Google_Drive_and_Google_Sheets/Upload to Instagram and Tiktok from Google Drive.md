...
graph TD
    ...
    Error_Trigger(("Error Trigger")):::trigger
    Telegram["Telegram"]
    If{"If"}:::logic
    Get_Audio_from_Video(["Get Audio from Video"]):::ai
    Read_video_from_Google_Drive["Read video from Google Drive"]
    Generate_Description_for_Videos_in_Tiktok_and_Instagram(["Generate Description for Videos in Tiktok and Instagram"]):::ai
    Read_Video_from_Google_Drive["Read Video from Google Drive"]
    Read_Video_from_Google_Drive2["Read Video from Google Drive2"]
    Upload_Video_and_Description_to_Tiktok["Upload Video and Description to Tiktok"]
    Upload_Video_and_Description_to_Instagram["Upload Video and Description to Instagram"]
