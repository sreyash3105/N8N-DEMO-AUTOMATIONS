...
graph TD
    ...
    Get_data_from_SerpBear["Get data from SerpBear"]
    Parse_data_from_SerpBear["Parse data from SerpBear"]
    Send_data_to_A_I__for_analysis["Send data to A.I. for analysis"]
