...
graph TD
    ...
    Get_Applicable_Rows["Get Applicable Rows"]
    Execute_Workflow_Trigger(("Execute Workflow Trigger")):::trigger
    Edit_Fields["Edit Fields"]
    Fallback_Response["Fallback Response"]
    SERP_Google_Reverse_Image_API["SERP Google Reverse Image API"]
    Reverse_Image_Search_Response["Reverse Image Search Response"]
    Reverse_Image_Search_Tool["Reverse Image Search Tool"]
    Firecrawl_Scrape_API["Firecrawl Scrape API"]
    Scrape_Success_{"Scrape Success?"}:::logic
    Firecrawl_Scrape_Success_Response["Firecrawl Scrape Success Response"]
    Firecrawl_scrape_Error_Response["Firecrawl scrape Error Response"]
    Firecrawl_Web_Scaper_Tool["Firecrawl Web Scaper Tool"]
    Structured_Output_Parser["Structured Output Parser"]
    Enrich_Product_Rows["Enrich Product Rows"]
    Analyse_Image(["Analyse Image"]):::ai
    Object_Identifier_Agent["Object Identifier Agent"]:::ai
