...
graph TD
    ...
    n_8_00am_Morning_Scheduled_Trigger(("8:00am Morning Scheduled Trigger")):::trigger
    Pull_List_of_Pinterest_Pins_From_Account["Pull List of Pinterest Pins From Account"]
    Update_Data_Field_To_Include_Organic["Update Data Field To Include Organic"]
    Create_Record_Within_Pinterest_Data_Table["Create Record Within Pinterest Data Table"]
    Pinterest_Analysis_AI_Agent["Pinterest Analysis AI Agent"]:::ai
    Pinterest_Data_Analysis_Summary_LLM["Pinterest Data Analysis Summary LLM"]
    Send_Marketing_Trends___Pinterest_Analysis_To_Marketing_Manager["Send Marketing Trends & Pinterest Analysis To Marketing Manager"]
