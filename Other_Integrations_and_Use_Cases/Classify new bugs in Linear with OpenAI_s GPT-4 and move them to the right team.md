...
graph TD
    ...
    Linear_Trigger(("Linear Trigger")):::trigger
    Only_tickets_that_need_to_be_classified["Only tickets that need to be classified"]
    Update_team["Update team"]
    Get_all_linear_teams["Get all linear teams"]
    Set_team_ID["Set team ID"]
    Set_me_up["Set me up"]
    Check_if_AI_was_able_to_find_a_team{"Check if AI was able to find a team"}:::logic
    Notify_in_Slack["Notify in Slack"]
