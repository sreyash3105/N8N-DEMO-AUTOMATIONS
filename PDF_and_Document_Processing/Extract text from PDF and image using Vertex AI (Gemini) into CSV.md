...
graph TD
    ...
    Get_PDF_or_Images(("Get PDF or Images")):::trigger
    Route_based_on_PDF_or_Image{"Route based on PDF or Image"}:::logic
    Download_PDF["Download PDF"]
    Download_Image["Download Image"]
    Extract_data_from_PDF["Extract data from PDF"]
    Send_data_to_A_I_["Send data to A.I."]
    Convert_to_CSV["Convert to CSV"]
    Upload_to_Google_Drive["Upload to Google Drive"]
    Convert_to_CSV2["Convert to CSV2"]
    Upload_to_Google_Drive1["Upload to Google Drive1"]
    Vertex_A_I__extract_text(["Vertex A.I. extract text"]):::ai
