...
graph TD
    ...
    Schedule_posting_every_6_hours(("Schedule posting every 6 hours")):::trigger
    Trigger_posting_manually(("Trigger posting manually")):::trigger
    Verify_tweet_constraints{"Verify tweet constraints"}:::logic
    Generate_tweet_content(["Generate tweet content"]):::ai
    Configure_your_influencer_profile["Configure your influencer profile"]
