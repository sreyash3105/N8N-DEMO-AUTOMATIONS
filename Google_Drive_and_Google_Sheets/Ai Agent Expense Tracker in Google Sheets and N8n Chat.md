...
graph TD
    ...
    Workflow_Input_Trigger(("fas:fa-bolt Workflow Input Trigger")):::trigger
    OpenAI_Chat_Model(["fas:fa-robot OpenAI Chat Model"]):::ai
    Window_Buffer_Memory[("fas:fa-robot Window Buffer Memory")]
    OpenAI_Chat_Model1(["fas:fa-robot OpenAI Chat Model1"]):::ai
    Expense_text_to_JSON_parser["fas:fa-robot Expense text to JSON parser"]
    Save_expense_into_Google_Sheets["fab:fa-google Save expense into Google Sheets"]
    Parse_msg_and_save_to_Sheets["fas:fa-robot Parse msg and save to Sheets"]
